                ...
                <div className="md:hidden">
                    ...
                    <div className="flex flex-col gap-2">
                        <Button
                            variant={activeTab === "sistem" ? "default" : "secondary"}
                            size="sm"
                            className={`w-full ${activeTab === "sistem" ? "shadow font-semibold" : ""}`}
                            onClick={() => setActiveTab("sistem")}
                        >
                            Sertifikat Sistem
                        </Button>
                        ...
                        <Button
                            variant={activeTab === "produk" ? "default" : "secondary"}
                            size="sm"
                            className={`w-full ${activeTab === "produk" ? "shadow font-semibold" : ""}`}
                            onClick={() => setActiveTab("produk")}
                        >
                            Sertifikat Produk
                        </Button>
                        ...
                        <Button
                            variant={activeTab === "pemeliharaan" ? "default" : "secondary"}
                            size="sm"
                            className={`w-full ${activeTab === "pemeliharaan" ? "shadow font-semibold" : ""}`}
                            onClick={() => setActiveTab("pemeliharaan")}
                        >
                            Pemeliharaan Data
                        </Button>
